...
<div class="row mb-3">
    ...
    <div class="col-md-6">
        ...
        <input type="text" id="new_type_poste" name="new_type_poste" class="form-control mt-2" placeholder="Enter new type_poste" style="display: none;">
    </div>
</div>
<script>
...
<div class="row mb-3">
    ...
    <div class="col-md-6">
        ...
        <input type="text" id="new_nom_bureau" name="new_nom_bureau" class="form-control mt-2" placeholder="Enter votre nom bureau" style="display: none;">
    </div>
</div>
